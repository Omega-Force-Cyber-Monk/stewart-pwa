...
export default function DashboardPage() {
  ...
  return <div className="space-y-6">
    ...
    <section><h3 className="mb-3 text-lg font-semibold text-slate-900">Quick Actions</h3><div className="grid gap-4 sm:grid-cols-2"><Link to="/selling-page" className="rounded-xl bg-white p-5 shadow-sm hover:shadow-md"><ExternalLink className="mb-3 h-5 w-5 text-blue-500" /><p className="font-semibold text-slate-900">View Your Selling Page</p><p className="mt-1 text-sm text-slate-500">Preview your selling page.</p></Link><button type="button" onClick={downloadReferral} className="rounded-xl bg-white p-5 text-left shadow-sm hover:shadow-md"><Download className="mb-3 h-5 w-5 text-blue-500" /><p className="font-semibold text-slate-900">Download Referral Card</p><p className="mt-1 text-sm text-slate-500">Download a printable referral card.</p></button><button type="button" onClick={copyLink} className="rounded-xl bg-white p-5 text-left shadow-sm hover:shadow-md"><Share2 className="mb-3 h-5 w-5 text-blue-500" /><p className="font-semibold text-slate-900">Share Your Page</p><p className="mt-1 text-sm text-slate-500">{copied ? "Link copied!" : "Copy and share your booking link."}</p></button><button type="button" onClick={() => setShowQr(true)} className="rounded-xl bg-white p-5 text-left shadow-sm hover:shadow-md"><QrCode className="mb-3 h-5 w-5 text-blue-500" /><p className="font-semibold text-slate-900">View QR Code</p><p className="mt-1 text-sm text-slate-500">Preview or download your QR code.</p></button></div></section>
