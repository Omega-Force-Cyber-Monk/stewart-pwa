...
export default function SellingPage() {
  ...
  const personalizedUrl = "http://book.quittheapp/eleanor-pena";
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-[1600px] mx-auto w-full">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 flex flex-col shadow-sm mb-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <a href="#" className="flex items-center gap-2 text-[#2ea043] hover:text-[#238636] font-bold text-[14px] transition-colors">
        ...
        <div className="flex flex-col xl:flex-row xl:items-center gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button 
              ...
              className={`flex items-center gap-2 px-5 py-3 rounded-xl font-bold text-[14px] transition-colors shadow-sm ${
                copied 
